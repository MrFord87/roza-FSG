...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <header className="bg-gradient-to-r from-yellow-900 to-black py-6 px-8 shadow-md">
        <h1 className="text-3xl font-bold tracking-wide text-yellow-400">ROZA Hub</h1>
        <p className="text-sm text-yellow-200">Your central command center for contracts</p>
      </header>
