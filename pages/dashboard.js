...
export default function Dashboard() {
  ...
  const handleSearch = async () => {
    const data = await fetchSAMData(filters);
...
✅ Updated! The advanced search interface now includes fields for:
...
Posted From / To dates


All filter inputs are wired up, and results will show beneath the search block when retrieved.

If you're ready, I’ll refactor the fetchSAMData function in utils/api.js to accept and properly query with these parameters. Let me know.
